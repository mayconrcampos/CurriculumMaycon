export default Vue.createApp({
    data() {
      return {
        ...
        atribuicoesConecta: ["Desenvolvimento FullStack", "JavaScript", "VueJS", "Python", "Flask", "Git", "Gcloud (Google Cloud Platform)", "Firebase", "Google DataStore - Banco não Relacional", "Plataforma Atlassian", "Jira", "Confluence", "BitBucket", "Metodologia Scrum", "etc..."],
        fecha: false,
